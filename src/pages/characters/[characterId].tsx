...
const CharacterDetailsPage: NextPageWithLayout = () => {
        ...
        <div className="self-end">
          ...
          <ul className="divide-y divide-dotted divide-ct-neutral-ligth-400/50 border-y border-ct-neutral-ligth-400 md:mb-0">
            {[
              ...
              { label: 'Last known location', value: data.actualLocation.name },
            ].map((v) => (
...
CharacterDetailsPage.getLayout = (page) => <MainLayout>{page}</MainLayout>;
