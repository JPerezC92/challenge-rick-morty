...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    return (
      <Text
        as="button"
        className={`whitespace-nowrap rounded-lg p-2 font-semibold shadow-sm outline-ct-neutral-ligth-400 transition-all ease-in-out disabled:pointer-events-none disabled:border-gray-400 disabled:opacity-60 ${background} ${outlineColor} ${className}`}
        {...props}
        ref={ref}
      >
        {children}
